 CREATE   PROCEDURE [ADP].[AVM_AssociateData_Monthly]    
...
SELECT * INTO #Associalte_Final_AVM FROM [Adp].Associate_Allocation_Raw WHERE Department_Name='ADM' OR Department_Name LIKE  '%AVM%' or  
...
END TRY    
 ...
 SELECT @ErrorMessage = ERROR_MESSAGE()    
  --INSERT Error        
  EXEC [AppVisionLens].[dbo].AVL_InsertError '[dbo].[Adp_AVM_AssociateData_Monthly] ', @ErrorMessage, '',''    
  RETURN @ErrorMessage    
  END CATCH       
