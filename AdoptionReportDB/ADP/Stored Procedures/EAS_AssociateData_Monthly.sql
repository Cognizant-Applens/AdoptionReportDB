CREATE   PROCEDURE [ADP].[EAS_AssociateData_Monthly]    
...
SELECT * INTO #Associalte_Final_AVM FROM [Adp].Associate_Allocation_Raw WHERE Department_Name='EAS' OR Department_Name LIKE  '%EAS%' or  
...
SELECT   
 [SBU] AS 'SBU'    
 ,ESA_FTE, ESA_FTE_Zero,ESA_FTE_0_25,ESA_FTE_25_50,ESA_FTE_50_80,ESA_FTE_80     ,Available_Hours    
 ,MPS_Effort    
 ,Work_Profile_AD  
 ,MAS_Effort    
 ,Actual_Effort    
...
END TRY    
 ...
 SELECT @ErrorMessage = ERROR_MESSAGE()    
  --INSERT Error        
  EXEC [AppVisionLens].[dbo].AVL_InsertError '[Adp].[EAS_AssociateData_Monthly] ', @ErrorMessage, '',''    
  RETURN @ErrorMessage    
  END CATCH       
