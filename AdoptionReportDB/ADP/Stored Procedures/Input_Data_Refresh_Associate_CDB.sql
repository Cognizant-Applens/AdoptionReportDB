CREATE PROCEDURE [ADP].[Input_Data_Refresh_Associate_CDB]
...
inner join [Adp].[Associate_Projects_CDB] AP on B.Project_ID =Ap.EsaProjectID
...
END TRY
 ...
 DECLARE @ErrorMessage VARCHAR(8000);
	SELECT @ErrorMessage = ERROR_MESSAGE()
		--INSERT Error    
		EXEC [AppVisionLens].dbo.AVL_InsertError '[Adp].[Input_Data_Refresh_Associate_CDB]', @ErrorMessage, '',''
		RETURN @ErrorMessage
  END CATCH   
