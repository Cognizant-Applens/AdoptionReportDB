USE [AdoptionReport]
GO
/****** Object:  StoredProcedure [ADPR].[Input_Data_Refresh_Associate]    Script Date: 11/3/2023 12:18:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [ADPR].[Input_Data_Refresh_Associate]
...
ELSE IF @ReportType = 'AIA' BEGIN
	...
	SELECT distinct EsaProjectID,PracticeOwner,DE_Inscope,SBU,[CHILDPROJECT] FROM [ADP].[Associate_Projects_AIA]
END
ELSE IF @ReportType = 'CDB' BEGIN
	INSERT into [Adp].[Input_Excel_Associate] (EsaProjectID,PracticeOwner,DE_Inscope,SBU,[CHILDPROJECT])
	SELECT distinct EsaProjectID,PracticeOwner,DE_Inscope,SBU,[CHILDPROJECT] FROM [ADP].[Associate_Projects_CDB]
END
ELSE IF @ReportType = 'EAS' BEGIN
	INSERT into [Adp].[Input_Excel_Associate] (EsaProjectID,PracticeOwner,DE_Inscope,SBU,[CHILDPROJECT])
	SELECT distinct EsaProjectID,PracticeOwner,DE_Inscope,SBU,[CHILDPROJECT] FROM [ADP].[Associate_Projects_EAS]
END
