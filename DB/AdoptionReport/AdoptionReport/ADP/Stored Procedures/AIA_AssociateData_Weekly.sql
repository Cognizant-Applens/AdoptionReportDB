create Procedure [Adp].[AIA_AssociateData_Weekly]  
...
INTO #Associalte_Final_AVM FROM [ADP].[Associate_Allocation_Raw] WHERE Department_Name='AIA' OR Department_Name LIKE  '%AIA%' or
...
DROP TABLE #VERTICALDATA_AVM 
 ...
 SELECT @ErrorMessage = ERROR_MESSAGE()  
  ...
  EXEC [$(AppVisionLens)].dbo.AVL_InsertError '[Adp].[AIA_AssociateData_Weekly] ', @ErrorMessage, '',''  
  RETURN @ErrorMessage  
  END CATCH     
