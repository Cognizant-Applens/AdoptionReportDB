create Procedure [Adp].[EAS_AssociateData_Weekly]  
...
INTO #Associalte_Final_AVM FROM [ADP].[Associate_Allocation_Raw] WHERE Department_Name='EAS' OR Department_Name LIKE  '%EAS%' or
...
DROP TABLE #VERTICALDATA_AVM 
 ...
 SELECT @ErrorMessage = ERROR_MESSAGE()  
  ...
  EXEC [$(AppVisionLens)].dbo.AVL_InsertError '[Adp].[EAS_AssociateData_Weekly]', @ErrorMessage, '',''  
  RETURN @ErrorMessage  
  END CATCH     
