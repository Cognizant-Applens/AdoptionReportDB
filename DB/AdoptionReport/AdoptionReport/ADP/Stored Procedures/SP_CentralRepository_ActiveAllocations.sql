...
IF EXISTS ( SELECT  top 1 1 FROM [$(GateWayServerName)].[$(AVMCOEESA)].[dbo].[GMSPMO_Associate] )
...
from [$(GateWayServerName)].[$(AVMCOEESA)].[dbo].[GMSPMO_Associate] WHERE Assignment_Status='A'
